...
Kommandot `SELECT` utför en _fråga_ (_query_), alltså hämtar data från en tabell. Det enklaste sättet att göra en fråga är att hämta all data från tabellen:
...
Följande fråga hämtar produktnamnen och produkternas priser.

```sql
SELECT name, price FROM Products;
```

Frågan ger nu följande resultat:
