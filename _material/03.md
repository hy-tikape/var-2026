...
Tabellens kan exempelvis se ut på följande sätt:
...
2   Datanätverk             1         
3   Pro gradu-seminarium    1         
4   PHP-programmering       4         
5   Artificiellt neuronnät  3         
```
...
Datanätverk             Kaila    
Pro gradu-seminarium    Kaila    
PHP-programmering       Laaksonen
Artificiellt neuronnät  Kivinen  
```
