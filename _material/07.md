---
title: 7. Databasernas egenskaper
slug: osa7
sections:
- Dataintegritet
- Transaktioner
...
Vi kan begära en mer sammanfattad frågeplan genom att sätta orden `EXPLAIN QUERY PLAN` framför frågan. Resultatet kan bli följande:
